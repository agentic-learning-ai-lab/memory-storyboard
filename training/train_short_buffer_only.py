...
from replay_buffer import FIFOBatchSampler
...
class Trainer():
    ...
    def train(self):
        ...
        self.shortmem_sampler = FIFOBatchSampler(data_source=self.shortmem_dataset, buffer_size=self.args.short_buffer_size, step_frame_size=self.args.curr_batch_size, batch_size=self.args.replay_batch_size, subsample=self.args.subsample, init_buffer_size=self.args.short_buffer_size)
...
if __name__=='__main__':
    ...
    parser.add_argument('--short_buffer_size', default=10000, type=int, help='size of short term memory replay buffer')
